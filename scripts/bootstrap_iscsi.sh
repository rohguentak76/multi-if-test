...
targetcli /iscsi create iqn.2015-01.com.whamcloud.lu:oss2
...
do
    targetcli /backstores/block create ost${x} /dev/ost${x}
    targetcli /iscsi/iqn.2015-01.com.whamcloud.lu:oss2/tpg1/luns/ create /backstores/block/ost${x}
done
...
targetcli /iscsi/iqn.2015-01.com.whamcloud.lu:oss2/tpg1/portals/ create ${ISCI_IP}
...
targetcli /iscsi/iqn.2015-01.com.whamcloud.lu:oss2/tpg1/portals/ create ${ISCI_IP2}
...
targetcli /iscsi/iqn.2015-01.com.whamcloud.lu:oss2/tpg1/acls create iqn.2015-01.com.whamcloud:oss3
targetcli /iscsi/iqn.2015-01.com.whamcloud.lu:oss2/tpg1/acls create iqn.2015-01.com.whamcloud:oss4
